...
```
Hover over to see the number of institutions per countrys
...
ggplotly(pl,tooltip="text")
```
Hover over each country to see the number of institutions and over the points to see the institution name
...
ggplotly(pl,tooltip = "text")
```
Hover over each state to see the number of institutions and over the points to see the institution name
...
Hover over to see the most common keyword used per country