...
The topic for *global alignment sequence* and *read alignment sequence* is hard coded because the corresponding information in the search terms dataframe does not have the word "sequence", the topic could not be joined by matching search terms.
