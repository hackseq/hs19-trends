...
- Papers were pulled from PLoS using Fulltext
- The data is limited to when PLoS was established in 2003 to the Present
- Search terms were identified based on previous knowledge
...
```{r, include=FALSE}
anim_save("../figures/sequencing_race.gif", animation = last_animation(), width = 12, height = 8)
```
