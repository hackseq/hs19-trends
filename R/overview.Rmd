...
ggsave(here::here("figures", "overview.png"), height = 8, width =12, device = "png")
```
...
ggsave(filename = here::here("figures", "sequencing.pdf"), width = 12, height = 8, device = "pdf")
```
...
ggsave(filename = here::here("figures", "alignment.pdf"), width = 12, height = 8, device = "pdf")
```
